...
<body>
    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center border-0">Sediaan</th>
                <th scope="col" class="text-center border-0">PT</th>
        ...
        <tbody>
            ...
            @foreach ($invoice->items as $item)
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $item->sediaan }}</td>
    ...
    @if ($invoice->notes)
        <p>
            ...
            <strong>Keterangan: {!! $invoice->notes !!}</strong>
        </p>
    @endif
